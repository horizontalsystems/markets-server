module.exports = {
  up: async (queryInterface) => {
    ...
    await queryInterface.bulkInsert('platforms', [
      ...
      { coin_id: 2, type: 'bep20', decimal: 18, address: '0x2170ed0880ac9a755fd29b2688956bd959f933f8' },
      { coin_id: 3, type: 'cardano', decimal: 6 },
      { coin_id: 4, type: 'erc20', decimal: 6, address: '0xdac17f958d2ee523a2206206994597c13d831ec7' },
      { coin_id: 4, type: 'bep20', decimal: 18, address: '0x55d398326f99059ff775485246999027b3197955' },
      { coin_id: 4, type: 'sol20', decimal: 18, address: 'Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB' },
      ...
      { coin_id: 9, type: 'bep2', decimal: 8, symbol: 'BNB' },
      { coin_id: 10, type: 'bep20', decimal: 18, address: '0x4b0f1812e5df2a09796481ff14017e6005508003' },
      { coin_id: 10, type: 'bep2', decimal: 8, symbol: 'TWT-8C2' },
    ], {})
  },
