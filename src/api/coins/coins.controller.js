...
exports.fundsInvested = async ({ params, currencyRate }, res) => {
  const fundsInvested = await FundsInvested.getByCoin(params.uid)
  res.send(serializer.serializeFundsInvested(fundsInvested, currencyRate))
}
