...
router.get('/dex-volumes', validateDexVolumes, setDexDateInterval, controller.dexVolume)
...
router.get('/dex-liquidity', validateDexLiquidity, setDexDateInterval, controller.dexLiquidity)
